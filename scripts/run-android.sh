...
export GOCACHE="${GOCACHE:-/private/tmp/go-fr010-gocache}"
...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.fr010 \
    -o android/app/libs/fr010.aar \
    ./mobile
...
echo "→ Lancement de FR-010"
$adb_path shell am force-stop com.olivierh.fr010
$adb_path shell am start -n com.olivierh.fr010/.MainActivity
